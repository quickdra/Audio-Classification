...
file_path = '../audio-cats-and-dogs/' #File path for the folder where the audio files are located
csv = '../audio-cats-and-dogs/train_test_split.csv' #CSV file containing the names of the audio files
...
history = train_model(model, n_cat, n_dog)
#Accuracy plot
